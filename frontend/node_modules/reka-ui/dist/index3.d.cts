...
import * as _vueuse_shared6 from "@vueuse/shared";
...
declare function useBodyScrollLock(initialState?: boolean | undefined): vue12.WritableComputedRef<boolean, boolean>;
 ...
 */
declare function useDirection(dir?: Ref<Direction | undefined>): vue12.ComputedRef<Direction>;
...
declare function useFormControl(el: MaybeElementRef): vue12.ComputedRef<boolean>;
...
declare function useForwardExpose<T extends ComponentPublicInstance>(): {
  ...
  currentRef: vue12.Ref<Element | T | null | undefined, Element | T | null | undefined>;
  currentElement: vue12.ComputedRef<HTMLElement>;
};
 ...
 */
declare function useForwardProps<T extends Record<string, any>>(props: MaybeRefOrGetter<T>): vue12.ComputedRef<WithOptionalBooleans<T>>;
//#endregion
 ...
 */
declare function useForwardPropsEmits<T extends Record<string, any>, Name extends string>(props: MaybeRefOrGetter<T>, emit?: (name: Name, ...args: any[]) => void): vue12.ComputedRef<{ [K in keyof T as [T[K]] extends [boolean] ? K : never]?: T[K] | undefined } & { [K_1 in keyof T as [T[K_1]] extends [boolean] ? never : K_1]: T[K_1] } & Record<string, any>>;
...
declare function useGraceArea(triggerElement: Ref<HTMLElement | undefined>, containerElement: Ref<HTMLElement | undefined>): {
  isPointerInTransit: _vueuse_shared6.RefAutoResetReturn<boolean>;
  onPointerExit: _vueuse_shared6.EventHookOn<void>;
};
 ...
 */
declare function useLocale(locale?: Ref<string | undefined>): vue12.ComputedRef<string>;
...
declare function useSize(element: MaybeElementRef): {
  width: vue12.ComputedRef<number>;
  height: vue12.ComputedRef<number>;
};
...
declare function useTypeahead(callback?: (search: string) => void): {
  search: _vueuse_shared6.RefAutoResetReturn<string>;
